...
public class UsuarioDAO extends DAO {
  ...
  public static final Map<String, String> camposFiltraveis = Map.of(
      ...
      "desc_tipoacesso", "Descrição do Tipo de Acesso",
      "status", "Status",
  ...
  public Object converterValor(String campo, String valor){
      try{
          return switch(campo){
              case "tipo_acesso" -> Integer.parseInt(valor);
              case "status" -> Boolean.parseBoolean(valor);
              case "data_nascimento" -> LocalDate.parse(valor);
              case "data-criaca" -> LocalDateTime.parse(valor);
              case "nome", "genero", "cargo", "email", "desc_tipoacesso" -> valor;
  ...
  public void cadastrar(CadastroUsuarioDTO credenciais) throws SQLException {
    ...
    TipoAcesso tipoAcesso = TipoAcesso.GERENCIAMENTO;
    boolean status = true;
